      ...
      <section className='flex flex-col xl:flex-row items-center md:justify-between gap-0 xl:gap-16 w-full mb-20' >
        <div className="flex flex-col justify-center gap-6 xl:gap-10 w-full xl:w-3/5">
            <div  className="flex justify-center flex-col text-6xl">
                <h1 className="flex justify-center xl:text-6xl text-2xl">Leandro Labiano</h1>
                <h1 className="flex justify-center xl:text-2xl text-xl text-gray-100" >solidity developer</h1>
            </div>
            <span className="mx-2"> 
